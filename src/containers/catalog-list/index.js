...
function CatalogList() {
  ...
  const callbacks = {
    ...
    addItem: (id) => store.actions.catalog.addItem(id),
    removeItem: (id) => store.actions.catalog.removeItem(id),
  };
    ...
    item: useCallback(
      item => (
        <Item
          ...
          inner={select.inner}
          select={callbacks.selectedItem}
          add={callbacks.addItem}
          remove={callbacks.removeItem}
        />
      ),
